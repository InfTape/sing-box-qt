...
void MainWindow::setupNavigation() {
  ...
  QList<NavItem> items = {{tr("Home"), "home"},
                          {tr("Proxy"), "proxy"},
                          {tr("Subscription"), "sub"},
                          {tr("Connections"), "conn"},
                          {tr("Rules"), "rule"},
...
void MainWindow::setupConnections() {
  ...
  if (!m_runtimeBinder && m_proxyRuntimeController) {
    m_runtimeBinder =
        std::make_unique<RuntimeUiBinder>(m_proxyRuntimeController,
                                          m_homeView,
                                          m_connectionsView,
                                          m_proxyView,
                                          m_rulesView,
...
void MainWindow::setupProxyUiBindings() {
  ...
  connect(m_proxyUiController,
          &ProxyUiController::tunModeStateChanged,
          m_homeView,
          &HomeView::setTunModeEnabled);
  connect(m_proxyUiController,
