...
void HttpClient::post(const QString &url, const QByteArray &data, Callback callback)
{
    QNetworkRequest request = createRequest(url);
...
void HttpClient::put(const QString &url, const QByteArray &data, Callback callback)
{
    QNetworkRequest request = createRequest(url);
