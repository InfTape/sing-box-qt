...
class SubscriptionService : public QObject {
 ...
 public:
  ...
  void addUrlSubscription(const QString& url, const QString& name,
                          bool useOriginalConfig, int autoUpdateIntervalMinutes,
                          bool applyRuntime, bool enableSharedRules = true,
                          const QStringList& ruleSets = {});
  void addManualSubscription(const QString& content, const QString& name,
  ...
  void updateSubscriptionMeta(const QString& id, const QString& name,
                              const QString& url, bool isManual,
