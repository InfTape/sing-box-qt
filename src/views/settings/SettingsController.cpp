...
SettingsController::SettingsController(QObject* parent)
    : QObject(parent), m_kernelManager(new KernelManager(this)) {
  connect(m_kernelManager,
          &KernelManager::installedInfoReady,
          this,
          &SettingsController::installedInfoReady);
  connect(m_kernelManager,
          &KernelManager::releasesReady,
          this,
  ...
  connect(m_kernelManager,
          &KernelManager::statusChanged,
          this,
          &SettingsController::statusChanged);
  connect(m_kernelManager,
          &KernelManager::finished,
          this,
...
bool SettingsController::saveSettings(const SettingsModel::Data& data,
                                      int                        themeIndex,
                                      int                        languageIndex,
                                      QString* errorMessage) const {
  return SettingsService::saveSettings(
      data, themeIndex, languageIndex, errorMessage);
}
