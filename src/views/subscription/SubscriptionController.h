...
class SubscriptionController {
 public:
  ...
  void addUrl(const QString& url, const QString& name, bool useOriginalConfig,
              int autoUpdateIntervalMinutes, bool applyRuntime,
              bool enableSharedRules, const QStringList& ruleSets);

  void addManual(const QString& content, const QString& name,
                 bool useOriginalConfig, bool isUriList, bool applyRuntime,
                 bool enableSharedRules, const QStringList& ruleSets);
  ...
  void updateSubscription(const QString& id, const QString& name,
